	...
	<div class="container" ng-app="app">
			...
			<div class="row">
				<div ng-controller="postController" class="col-md-3">
					<form name="customerForm" ng-submit="submitForm()">
						...
						<input type="text" name="contact" class="form-control" ng-model="contact" />
						<label>Adresse</label> <input type="text" name="address" class="form-control" ng-model="address" />
					...
					<div class="col-lg-12 col-sm-12 col-xs-12 alert alert-success ng-hide" ng-show="isDisplay">
		...
		<div class="row">
			...
			<div ng-controller="getcustomerController" class="col-md-3">
				...
				<input type="text" class="form-control" style="width: 100px;" ng-model="customerId" /> <br />
				<button ng-click="getCustomer()">Get Customer</button>

				<div ng-show="showCustomer">
					Id: {{customer.data.id}}<br /> First Name: {{customer.data.firstName}}<br /> Last Name: {{customer.data.lastName}}
				</div>
				<p>{{getResultMessage}}</p>
			</div>
				...
				<div ng-show="showCustomersByLastName">
					...
					<ul class="list-group">
						<li ng-repeat="customer in allcustomersbylastname.data"><h4 class="list-group-item">
								<strong>Customer {{$index}}</strong><br /> Id: {{customer.id}}<br /> First Name: {{customer.firstName}}<br /> Last Name:
								{{customer.lastName}}
							</h4></li>
					</ul>
				</div>
